				...
				<span class="row-fluid">
					<span class="span10">
						<div class="input-prepend">
							<span class="pull-right" style="display: none;"><!-- Hide unwanted fields  -->
					...
					<span class="input-append span2 margin0px" style="display: none;"><!-- Hide unwanted fields  -->
							<span class="add-on selectEmail cursorPointer"><i class="icon-search" title="{vtranslate('LBL_SELECT', $MODULE)}"></i></span>
					</span>
<!--    *****************               Attach Document To Send Mail             *************          -->
                                		<div class="span10">
						  <span>Ohne Standardanhänge senden</span>
						  <span> <input id='AttachtAllDocument'name='attach_All_Created_Document'value='attachAllCreatedDocument' type ='checkbox'><span>
                               			</div>
<!--             ***********************       End      *********************************       -->					
				</span>
			</span>
